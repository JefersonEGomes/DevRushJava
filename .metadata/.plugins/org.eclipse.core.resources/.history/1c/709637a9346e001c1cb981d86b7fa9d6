...
/* Desafio  digitar uma String referente a um dia da semana e
 retornar um inteiro referente ao dia em uma sequência de 1 a 7
 */
public class DesafioDiaDaSemana {
	
	public static void main(String[] args) {
		Scanner leitor = new Scanner(System.in);
		System.out.println("Digite o dia que vocÇe deseja verificar: ");
		String dia = leitor.next();
		/*
		 Tips & Tricks
		 
		 Utilizar a função .equalsIgnoreCase() 
		 
		 */ 
		if(dia.isEmpty()) {
			System.out.println("Por favor preencha com um dia válido");
